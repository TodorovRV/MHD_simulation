...
class VectorBField {
    public:
        ...
        virtual Vector3d bf_plasma_frame(const Vector3d &point, Vector3d &v) const = 0;
...
class ToroidalBField : public VectorBField {
    public:
        ...
        Vector3d _bf(const Vector3d &point) const override ;
        Vector3d bf_plasma_frame(const Vector3d &point, Vector3d &v) const override;
    private:
        double b_0_;
        double n_b_;
};
...
class BeskinMHDBField : public VectorBField {
    public:
        BeskinMHDBField(double Psi_tot, double sigma_m, double Omega, double theta);
        Vector3d _bf(const Vector3d &point) const override;
        Vector3d bf_plasma_frame(const Vector3d &point, Vector3d &v) const override;
        Vector3d ef(const Vector3d &point) const;
    private:
        double Psi_tot_;
        double sigma_m_;
        double Omega_;
